...
while (to_language not in dic_language):  
    print("The language in which the user wants to convert the voice command is currently not available. The user is requested to input another language.")
